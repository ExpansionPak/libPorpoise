 ...
 * Size:	0000D0
 */
static void MTXPerspectiveImpl(Mtx m, f32 fovY, f32 aspect, f32 n, f32 f)
{
	f32 angle;
	f32 cot;
	f32 tmp;
...
{
	MTXPerspectiveImpl(m, fovY, aspect, n, f);
}
 ...
 * Size:	000098
 */
static void MTXOrthoImpl(Mtx m, f32 t, f32 b, f32 l, f32 r, f32 n, f32 f)
{
	f32 tmp;
