...
{
	TekiLowerRangeCondition lowerRange(mTeki);
	TekiStickerCondition stickerCond(mTeki);
	TekiNotCondition notSticker(&stickerCond);
	TekiAndCondition condition(&lowerRange, &notSticker);
