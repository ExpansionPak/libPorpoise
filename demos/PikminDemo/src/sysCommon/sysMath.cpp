...
{
	return mNormal.x == other.mNormal.x && mNormal.y == other.mNormal.y && mNormal.z == other.mNormal.z && mOffset == other.mOffset;
}
...
{
	f32 lengthSq = mNormal.x * mNormal.x + mNormal.y * mNormal.y + mNormal.z * mNormal.z;
	if (lengthSq <= 0.0f) {
		return 0.0f;
	}
	return 1.0f / sqrtf(lengthSq);
}
 ...
 * Size:    0002A0
 */
void Quat::fromEuler(const Vector3f& angles)
{
	STACK_PAD_VAR(3);
