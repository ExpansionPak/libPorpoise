 ...
 * Size:	000070
 */
void AyuStack::create(const char* name, int allocType, void* stackTop, int stackSize, bool isProtectionEnabled)
{
 ...
 * Size:	000074
 */
void AyuHeap::init(const char* name, int allocType, void* stackTop, int stackSize)
{
