 ...
 */
void Matrix4f::makeRotate(const Vector3f& axis, f32 angleSin, f32 angleCos)
{
	f32 x = axis.x;
	f32 y = axis.y;
	f32 z = axis.z;
 ...
 * Size:	00006C
 */
void Matrix4f::makeRotate(const Vector3f& axis, f32 angle)
{
 ...
 * Size:	000020
 */
void Matrix4f::multiplyTo(const Matrix4f& mtxB, Matrix4f& outMtx) const
{
 ...
 * Size:	00019C
 */
void Matrix4f::makeSRT(const Vector3f& scale, const Vector3f& rotation, const Vector3f& translation)
{
	u32 stackFix[6];
 ...
 * Size:	0001AC
 */
void Matrix4f::makeConcatSRT(Matrix4f* a, Matrix4f& b, const SRT& srt)
{
	u32 stackFix[6];
 ...
 * Size:	000300
 */
void Matrix4f::makeLookat(const Vector3f& cameraPos, const Vector3f& targetPos, Vector3f* optionalUp)
{
	Vector3f forward;
	Vector3f right;
	Vector3f up;
 ...
 * Size:	000100
 */
void Matrix4f::makeLookat(const Vector3f& cameraPos, const Vector3f& rightDir, const Vector3f& upDir, const Vector3f& backDir)
{
	setRow(0, rightDir);
 ...
 * Size:	00012C
 */
void Matrix4f::makeVQS(const Vector3f& translation, Quat& rotation, const Vector3f& scale)
{
