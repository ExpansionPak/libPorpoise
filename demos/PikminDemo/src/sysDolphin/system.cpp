 ...
 * Size:	0000b8
 */
void System::halt(const char* file, int line, const char* message)
{
#if 0 // DLL's version
	char buffer[2048];
 ...
 * Size:	00004C
 */
void doneDMA(ARQRequest* request)
{
	SystemCache* sysCache = (SystemCache*)request->owner;
	sysCache->remove();
 ...
 * Size:	0000C0
 */
void freeBuffer(ARQRequest* request)
{
	CacheTexture* texCache = (CacheTexture*)request->owner;
