 ...
 * Size:	00019C
 */
void DGXGraphics::setOrthogonal(Mtx mtx, const RectArea& bounds)
{
 ...
 * Size:	00003C
 */
void DGXGraphics::setScissor(const RectArea& bounds)
{
 ...
 * Size:	000098
 */
void DGXGraphics::setViewport(const RectArea& bounds)
{
 ...
 * Size:	000030
 */
void DGXGraphics::setViewportOffset(const RectArea& bounds)
{
...
void DGXGraphics::initProjTex(bool set, LightCamera* cam)
{
	...
	Mtx mtx;
	if (set) {
		C_MTXLightPerspective(mProjectionTextureMatrix, cam->mFov, cam->mAspectRatio, cam->mProjectionScale.x, -cam->mProjectionScale.y, 0.5f,
		                      0.5f);
 ...
 * Size:	00009C
 */
void DGXGraphics::setColour(const Colour& color, bool set)
{
 ...
 * Size:	00000C
 */
void DGXGraphics::setAuxColour(const Colour& color)
{
	mAuxiliaryColour = color;
}
 ...
 * Size:	000060
 */
void DGXGraphics::setPrimEnv(const Colour* col1, const Colour* col2)
{
	if (col1) {
 ...
 * Size:	00000C
 */
void DGXGraphics::setClearColour(const Colour& color)
{
 ...
 * Size:	000040
 */
void DGXGraphics::setFog(bool set, const Colour& color, f32 density, f32 start, f32 end)
{
	mFogColour  = color;
	mFogStart   = start;
	mFogEnd     = end;
 ...
 * Size:	000328
 */
void DGXGraphics::drawRotParticle(Camera& cam, const Vector3f& pos, u16 angle, f32 radius)
{
 ...
 * Size:	00027C
 */
void DGXGraphics::drawParticle(Camera& cam, const Vector3f& pos, f32 size)
{
	gsys->mPolygonCount += 2;
 ...
 * Size:	000128
 */
void DGXGraphics::drawCamParticle(Camera& cam, const Vector3f& pos, const Vector2f& extents, const Vector2f& uvMin, const Vector2f& uvMax)
{
	gsys->mPolygonCount += 2;
 ...
 * Size:	0000F4
 */
void DGXGraphics::drawLine(const Vector3f& start, const Vector3f& end)
{
	useTexture(nullptr, 0);
	GXClearVtxDesc();
	GXSetVtxDesc(GX_VA_POS, GX_DIRECT);
 ...
 * Size:	00021C
 */
void DGXGraphics::blatRectangle(const RectArea& rect)
{
	GXClearVtxDesc();
	GXSetVtxDesc(GX_VA_POS, GX_DIRECT);
	GXSetVtxDesc(GX_VA_CLR0, GX_DIRECT);
 ...
 * Size:	0001C8
 */
void DGXGraphics::testRectangle(const RectArea& rect)
{
	u32 primClr = *(u32*)&mPrimaryColour;
	GXClearVtxDesc();
	GXSetVtxDesc(GX_VA_POS, GX_DIRECT);
 ...
 * Size:	00046C
 */
void DGXGraphics::drawRectangle(const RectArea& bounds, const RectArea& texCoords, Vector3f* offset)
{
	GXClearVtxDesc();
	GXSetVtxDesc(GX_VA_POS, GX_DIRECT);
	GXSetVtxDesc(GX_VA_CLR0, GX_DIRECT);
 ...
 * Size:	0001DC
 */
void DGXGraphics::lineRectangle(const RectArea& rect)
{
	GXClearVtxDesc();
	GXSetVtxDesc(GX_VA_POS, GX_DIRECT);
	GXSetVtxDesc(GX_VA_CLR0, GX_DIRECT);
 ...
 * Size:	0000F8
 */
void DGXGraphics::directDrawChar(const RectArea&, const RectArea&)
{
	// UNUSED FUNCTION
}
 ...
 * Size:	000108
 */
void DGXGraphics::directErase(const RectArea&, bool)
{
	// UNUSED FUNCTION
}
