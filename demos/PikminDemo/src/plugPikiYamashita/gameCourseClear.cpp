...
struct GameCourseClearScreen : public Node {
	...
	GameCourseClearScreen()
	{
		...
		mMainMenu->addOption(0, "Quit", new Delegate1<GameCourseClearScreen, Menu&>(this, &GameCourseClearScreen::menuQuitGame), true);
		mActiveMenu = 0;
...
GameCourseClearSection::GameCourseClearSection()
{
	...
	Vector3f initialPtclPos(0.0f, 0.0f, 0.0f);
	screen->mPtclManager.createGenerator(screen->mPtclLoader.load("effects/pcr/pk_dead.pcr", true),
	                                     ...
	                                     gsys->loadTexture("effects/tex/soulf3.bti", true), initialPtclPos, nullptr, nullptr);
