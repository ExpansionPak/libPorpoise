...
void zen::DrawCMcourseSelect::start()
{
	...
	mBest.hide();
	setBestScore();
	Vector3f effectPos(320.0f, 240.0f, 0.0f);
	mEffectMgr2D->create(EFF2D_Unk25, effectPos, nullptr, nullptr);
	mEffectMgr2D->create(EFF2D_Unk26, effectPos, nullptr, nullptr);
	mEffectMgr2D->create(EFF2D_Unk27, effectPos, nullptr, nullptr);
	mEffectMgr2D->create(EFF2D_Unk28, effectPos, nullptr, nullptr);
	mEffectMgr2D->create(EFF2D_Unk29, effectPos, nullptr, nullptr);
	mEffectMgr2D->create(EFF2D_Unk30, effectPos, nullptr, nullptr);
	mEffectMgr2D->create(EFF2D_Unk31, effectPos, nullptr, nullptr);
	mEffectMgr2D->create(EFF2D_Unk32, effectPos, nullptr, nullptr);
	_90 = 0;
	P2DPaneLibrary::setFamilyAlpha(_8C, _90);
	PRINT("start! \n");
}
