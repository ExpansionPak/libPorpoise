...
#ifndef PORPOISE_ENABLE_AGE
#define PORPOISE_ENABLE_AGE 0
#endif

#if PORPOISE_ENABLE_AGE
...
//#ifdef WIN32
	...
	void NewOption(const char* name, int a)
	{
		writeInt(1);
		writeString(name);
		writeInt(a);
...
struct AgeServer : public AtxStream {
	...
	template <typename... Args> void Done(Args&&...) { }
	template <typename... Args> void EndBitGroup(Args&&...) { }
	template <typename... Args> void EndGroup(Args&&...) { }
	template <typename... Args> void EndNode(Args&&...) { }
	template <typename... Args> void EndOptionBox(Args&&...) { }
	template <typename... Args> void EndSection(Args&&...) { mIsActive = false; }
	template <typename... Args> void NewBit(Args&&...) { }
	template <typename... Args> void NewButton(Args&&...) { }
	template <typename... Args> void NewEditor(Args&&...) { }
	template <typename... Args> void NewLabel(Args&&...) { }
	template <typename... Args> void NewNode(Args&&...) { }
	template <typename... Args> void NewNodeWindow(Args&&...) { }
	template <typename... Args> void NewOption(Args&&...) { }
	template <typename... Args> void NewPropWindow(Args&&...) { }
	template <typename... Args> void NewViewer(Args&&...) { }
	template <typename... Args> void RefreshNode(Args&&...) { }
	template <typename... Args> void RefreshSection(Args&&...) { }
	template <typename... Args> void StartBitGroup(Args&&...) { }
	template <typename... Args> void StartGroup(Args&&...) { }
	template <typename... Args> void StartOptionBox(Args&&...) { }
	template <typename... Args> void StartSection(Args&&...) { }
	template <typename... Args> void readPropValue(Args&&...) { }
	template <typename... Args> void setOnChange(Args&&...) { }
	template <typename... Args> void setSectionRefresh(Args&&...) { }
	template <typename... Args> void writeProp(Args&&...) { }
	template <typename... Args> void writePropValue(Args&&...) { }

	bool Open() { mIsActive = false; return false; }
	void close() override { AtxStream::close(); }
	bool getOpenFilename(String&, char*) { return false; }
	bool getSaveFilename(String&, char*) { return false; }
	int update() { return 0; }

	bool mIsActive = false;
};

#endif // PORPOISE_ENABLE_AGE
