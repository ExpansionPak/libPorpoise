...
public:
	...
	void init(u8* data, Texture* tex, Texture* childTex, const Vector3f& pos, particleMdlManager* mdlMgr, CallBack1<particleGenerator*>* cbGen,
	...
	void setEmitPos(const Vector3f& pos) { mEmitPos = pos; }
	void setEmitPosPtr(Vector3f* posPtr) { mEmitPosPtr = posPtr; }
	void setEmitDir(Vector3f& dir) { mEmitDir = dir; }
	void setEmitDir(const Vector3f& dir) { mEmitDir = dir; }
	void setEmitVelocity(Vector3f& vel) { mEmitVelocity = vel; }
	void setEmitVelocity(const Vector3f& vel) { mEmitVelocity = vel; }
	void setOrientedNormalVector(Vector3f& vec) { mOrientedNormal = vec; }
	void setOrientedNormalVector(const Vector3f& vec) { mOrientedNormal = vec; }
	...
	void setAirField(const Vector3f& vel, bool set)
	{
	...
	void setGravityField(const Vector3f& accel, bool set)
	{
...
public:
	...
	particleGenerator* createGenerator(u8*, Texture*, Texture*, const Vector3f&, CallBack1<particleGenerator*>*,
