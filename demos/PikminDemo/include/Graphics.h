...
struct Graphics {
	...
	void drawCylinder(const Vector3f&, const Vector3f&, f32, const Matrix4f&);
	void drawSphere(const Vector3f&, f32, const Matrix4f&);
	int calcLighting(f32);

	// unused/inlined:
	void drawCircle(const Vector3f&, f32, const Matrix4f&);
	int calcSphereLighting(const Vector3f&, f32);
	int calcBoxLighting(const BoundBox&);
	...
	virtual void setOrthogonal(Mtx, const RectArea&)          = 0;                         // _40
	virtual void setLightcam(LightCamera* cam) { mLightCam = cam; }                        // _44
	virtual void setViewport(const RectArea&)       = 0;                                   // _48
	virtual void setViewportOffset(const RectArea&) = 0;                                   // _4C
	virtual void setScissor(const RectArea&)        = 0;                                   // _50
	...
	virtual void drawParticle(Camera&, const Vector3f&, f32)                          = 0; // _8C
	virtual void drawRotParticle(Camera&, const Vector3f&, u16, f32)                  = 0; // _90
	virtual void drawCamParticle(Camera&, const Vector3f&, const Vector2f&, const Vector2f&, const Vector2f&) = 0; // _94
	virtual void drawLine(const Vector3f&, const Vector3f&)                           = 0; // _98
	...
	virtual void setColour(const Colour&, bool)                                       = 0; // _A8
	virtual void setAuxColour(const Colour&)                                          = 0; // _AC
	virtual void setPrimEnv(const Colour* primColor, const Colour* envColor)          = 0; // _B0
	virtual void setClearColour(const Colour&)                                        = 0; // _B4
	virtual void setFog(bool)                                                         = 0; // _B8
	virtual void setFog(bool, const Colour&, f32, f32, f32)                           = 0; // _BC
	...
	virtual void drawRectangle(const RectArea&, const RectArea&, Vector3f*) = 0;           // _D0
	virtual void fillRectangle(const RectArea&)                             = 0;           // _D4
	virtual void blatRectangle(const RectArea&)                             = 0;           // _D8
	virtual void lineRectangle(const RectArea&)                             = 0;           // _DC
	virtual void testRectangle(const RectArea&) { }                                        // _E0
...
struct DGXGraphics : public Graphics {
	...
	virtual void setOrthogonal(Mtx, const RectArea&);                                  // _40
	virtual void setViewport(const RectArea&);                                         // _48
	virtual void setViewportOffset(const RectArea&);                                   // _4C
	virtual void setScissor(const RectArea&);                                          // _50
	...
	virtual void drawParticle(Camera&, const Vector3f&, f32);                          // _8C
	virtual void drawRotParticle(Camera&, const Vector3f&, u16, f32);                  // _90
	virtual void drawCamParticle(Camera&, const Vector3f&, const Vector2f&, const Vector2f&, const Vector2f&); // _94
	virtual void drawLine(const Vector3f&, const Vector3f&);                           // _98
	virtual void drawPoints(Vector3f*, int);                                           // _9C
	virtual void drawOneTri(Vector3f*, Vector3f*, Vector2f*, int);                     // _A0
	virtual void setColour(const Colour&, bool);                                       // _A8
	virtual void setAuxColour(const Colour&);                                          // _AC
	virtual void setPrimEnv(const Colour*, const Colour*);                             // _B0
	virtual void setClearColour(const Colour&);                                        // _B4
	virtual void setFog(bool);                                                         // _B8
	virtual void setFog(bool, const Colour&, f32, f32, f32);                           // _BC
	virtual void setMaterial(Material*, bool);                                         // _C4
	virtual void useTexture(Texture*, int);                                            // _CC
	virtual void drawRectangle(const RectArea&, const RectArea&, Vector3f*);           // _D0
	virtual void fillRectangle(const RectArea&);                                       // _D4
	virtual void blatRectangle(const RectArea&);                                       // _D8
	virtual void lineRectangle(const RectArea&);                                       // _DC
	virtual void testRectangle(const RectArea&);                                       // _E0
	...
	void directDrawChar(const RectArea&, const RectArea&);
	void directPrint(int, int, char*, ...);
	void directErase(const RectArea&, bool);
