...
public:
	...
	void exit();
	zen::particleGenerator* create(EffectMgr::effTypeTable, const Vector3f&, zen::CallBack1<zen::particleGenerator*>*,
...
struct EffectParticleRegistration {
	...
	virtual zen::particleGenerator* create(const Vector3f& pos, zen::CallBack1<zen::particleGenerator*>* cbGen,
