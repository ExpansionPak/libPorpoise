...
struct PaniAnimator : public Animator {
	...
	void startMotion(const PaniMotionInfo&);
	void finishMotion(PaniMotionInfo&);
	void finishMotion(const PaniMotionInfo&);
...
inline void PaniAnimator::startMotion(const PaniMotionInfo& info)
{
	PaniMotionInfo copy(info);
	startMotion(copy);
}

inline void PaniAnimator::finishMotion(const PaniMotionInfo& info)
{
	PaniMotionInfo copy(info);
	finishMotion(copy);
}
