/*---------------------------------------------------------------------------*
  Project:  High level locked cache API demo
  File:     lockedcachedemo1.c
  ...
  $Log: /Dolphin/build/demos/osdemo/src/lockedcachedemo1.c $
...
void main ()
{
    ...
    {   
        for (i = 0; i < NUM_BUFFERS; i++)
        {
            ...
            LCQueueWait((NUM_BUFFERS-1)*numTransactions); 
