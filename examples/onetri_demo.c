/*---------------------------------------------------------------------------*
  ...
  Port of the official GameCube SDK onetri demo.
  Original: demos/gxdemo/src/Simple/smp-onetri.c
  
  This demo renders a 3D grid of strut models using indexed vertex arrays.
 *---------------------------------------------------------------------------*/
...
{
    OSReport("\n\n****************************************\n");
    OSReport("onetri_demo - Official GameCube SDK Demo\n");
    OSReport("****************************************\n");
    OSReport("to quit:\n");
    OSReport("     hit the start button (or close window)\n");
    OSReport("****************************************\n");
}
